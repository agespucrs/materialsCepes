<div class="head">
	...
	<ul>
		...
		<li><a href="main?acao=telaUser&isEdit=nao"    class="${param.isEdit eq 'nao' ? 'selected' : ''}">Cadastar Usuario</a></li>
		<li><a href="main?acao=telaUser&isEdit=sim"    class="${param.isEdit eq 'sim' ? 'selected' : ''}">Alterar Usuario</a></li>
