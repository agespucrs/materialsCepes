	...
	<ul class="menu" style="margin-top: 20px; margin-right: 20px; float: right;">
		...
		<li><a href="javascript: void(0)"><img src="img/books.png" width="12px"/> Livros</a>
			<ul class="submenu-1">
				...
				<li><a href="main?acao=listLivro" class="${param.acao eq 'listLivro' ? 'selected' : ''}">Listar Livro</a></li>
			</ul>	
		</li>
		...
		<li><a href="main?acao=logout" class="${param.acao eq 'logout' ? 'selected' : ''}"><img src="img/exit.png" width="12px"/> Sair</a></li>
	</ul>
</div>
<div style="background: #001117; height: 20px; border: 0px;">
		<p style="color: white; font-size: 12px; line-height: 20px; float: right; margin-right: 25px;">Usuário: <b> ${sessionScope.usuario.usuario}</b></p>
</div>
