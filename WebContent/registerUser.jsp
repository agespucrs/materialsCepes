...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
			...
			function cadastrar() {
				...
				formCadastro.action ="main?acao=registrar";
				formCadastro.submit();
			}
...
<body>
	<form method="post" action="">
		...
		<fieldset class="fieldset_register">
			...
			<div class="campo">
				<label for="usuario">Usuário</label> <sup class="red">*</sup> <input type="text" id="usuario" name="usuario" maxlength="15" value="${param.usuario}" />
			</div>
