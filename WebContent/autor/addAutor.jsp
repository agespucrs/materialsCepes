	...
	<link rel="stylesheet" href="./css/comum.css" />
		...
		<script type="text/javascript">
			...
			function cadastrar() {
				...
				formCadastro.action ="main?acao=addAutor";
				formCadastro.submit();
			}
		...
		<form action="" method="post" style="background: black;">
			...
			<fieldset style="background: URL('img/banner_black.jpg');min-height: 449px; border: none !important; color: #198AB0; padding: 25px; font-size: 12px; width: 100%; margin-top: -20px; top: -10px;">
				...
				<table cellpadding="5">
					<tr>
						<td>Nome</td>
						<td><input type="text" id="nome" name="nome"  value="${param.Nome}"  required/></td>
					</tr>
					<tr>
						<td>Sobrenome</td>
						<td><input type="text" id="sobrenome" name="sobrenome"  value="${param.Sobrenome}"  required/></td>
					</tr>
				</table>
				<br><br>
